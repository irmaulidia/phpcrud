    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">IRMA MAULIDIA</a>
            </div>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
             ...
             <div class="col-lg-12">
                        <h2>Tabel CRUD</h2> <a href="add.php?action=add" type="button" class="btn btn-xs btn-info">Add New</a>
